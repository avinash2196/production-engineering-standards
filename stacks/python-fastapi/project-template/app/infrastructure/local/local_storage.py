...
The adapter persists files under one configured root. It does not reproduce
managed object-store durability, IAM, lifecycle, replication, or multi-instance
semantics and is rejected by production settings validation.
"""
...
class LocalFileStorageProvider:
    ...
    async def upload(
        ...
        del content_type  # Contract metadata is not persisted by this minimal adapter.

...
| Agent | Purpose                                                                                   | File |
|-------|-------------------------------------------------------------------------------------------|------|
| **Backend Service Builder** | Scaffold production-grade services with layered architecture and justified capability/local-adapter boundaries | [backend-service-builder.md](backend-service-builder.md) |
| **Code Reviewer** | Review code changes against all production-grade standards                                | [code-reviewer.md](code-reviewer.md) |

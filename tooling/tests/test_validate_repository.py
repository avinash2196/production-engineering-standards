...
""",
    ...
    def test_agent_validation_accepts_native_agent_profile(self) -> None:
        self.write(
...
""",
        ...
        self.assertEqual([], validator.validate_agent_files(self.root))

    def test_agent_validation_requires_description(self) -> None:
        self.write(
            ".github/agents/code-reviewer.agent.md",
            """---
name: code-reviewer
...
""",
        ...
        self.assertEqual(
            [".github/agents/code-reviewer.agent.md: missing frontmatter field 'description'"],
            validator.validate_agent_files(self.root),
        )

    def test_agent_validation_requires_repository_filename_convention(self) -> None:
        self.write(
...
""",
        ...
        self.assertEqual(
            [
                ".github/agents/code-reviewer.md: custom-agent files must use the repository convention '*.agent.md'"
            ],
            validator.validate_agent_files(self.root),
        )

    def test_agent_validation_requires_name_to_match_filename(self) -> None:
        self.write(
            ".github/agents/code-reviewer.agent.md",
            """---
...
""",
        ...
        self.assertEqual(
            [
                ".github/agents/code-reviewer.agent.md: agent name 'architecture-reviewer' must match filename 'code-reviewer.agent.md'"
            ],
            validator.validate_agent_files(self.root),
        )

    def test_agent_validation_rejects_scalar_tools(self) -> None:
        self.write(
            ".github/agents/code-reviewer.agent.md",
            """---
name: code-reviewer
...
""",
        ...
        self.assertEqual(
            [
                ".github/agents/code-reviewer.agent.md: frontmatter field 'tools' must be a YAML list"
            ],
            validator.validate_agent_files(self.root),
        )

    def test_legacy_agents_directory_is_rejected(self) -> None:
        self.write("agents/legacy.md", "# Legacy\n")

        self.assertEqual(
            [
                "Legacy top-level agents/ directory is not allowed; use .github/agents/*.agent.md"
            ],
            validator.validate_no_legacy_agents_directory(self.root),
        )

    def test_repository_hygiene_rejects_cache_and_ide_artifacts(self) -> None:
        self.write(".idea/workspace.xml", "<project/>\n")
        self.write("tooling/__pycache__/helper.pyc", "not-bytecode")
        self.write("examples/.pytest_cache/README.md", "cache\n")

        self.assertEqual(
            [
                "Repository hygiene: remove generated bytecode 'tooling/__pycache__/helper.pyc'",
                "Repository hygiene: remove generated/local directory '.idea'",
                "Repository hygiene: remove generated/local directory 'examples/.pytest_cache'",
                "Repository hygiene: remove generated/local directory 'tooling/__pycache__'",
            ],
            validator.validate_repository_hygiene(self.root),
        )

...
Keep the repository model small and explicit.

1. Put standing rules in instructions.
2. Put reusable domain knowledge and supporting assets in a skill.
3. Create an agent only for a durable responsibility.
